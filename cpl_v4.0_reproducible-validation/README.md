...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo..17788635.svg)](https://doi.org/10.5281/zenodo..17788635)  
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE) - **Scientific article and associated documentation**  
[![License: CC BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by/4.0/) - **Source code and simulation scripts**  
...
cognitive-phase-law_cpl/
	└── cpl_v4.0_reproducible-validation/
		│
...
@misc{khomyakov_2025_17788635,
  ...
  publisher    = {Zenodo},
  version      = {4.0},
  doi          = {10.5281/zenodo.17788635},
  url          = {https://doi.org/10.5281/zenodo.17788635},
}
```
